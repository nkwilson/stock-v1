...
stocks=[
	...
	['600309', '万华化学', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  #8
        ['300176', '鸿特科技', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  #19
        ['600298', '安琪酵母', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  #26
        ['600519', '贵州茅台', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  #27
	['002008', '大族激光', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  #38
        ['603288', '海天味业', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  # PE=41
	['002507', '涪陵榨菜', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  # PE=44
        ['600436', ' 片仔癀', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],   #51
        ['600276', '恒瑞医药', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],  #73
        

	['002597', '金禾实业', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],        
	...
	['002035', '华帝股份', '2014-01-01', '', 100000, 4, '2015-01-01', 0.6, 1],
