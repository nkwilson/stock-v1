...
stocks=[
        ['600663.SS', '陆家嘴', '2016-01-01', '2016-12-31'],
        ['000333.SZ', '美的集团', '2016-01-01', '2016-12-31'],
        ['002673.SZ', '西部证券', '2016-01-01', '2016-12-31'],
        ['002407.SZ', '多佛多', '2016-01-01', '2016-12-31'],
        ['002460.SZ', '赣锋锂业', '2016-01-01', '2016-12-31'],
        ['300017.SZ', '网宿科技', '2016-01-01', '2016-12-31'],
        ['300027.SZ', '华谊兄弟', '2016-01-01', '2016-12-31'],
        ['300251.SZ', '光线传媒', '2016-01-01', '2016-12-31'],
        ['000938.SZ', '紫光股份', '2016-01-01', '2016-12-31'],
        ['600547.SS', '山东黄金', '2016-01-01', '2016-12-31'],
        ['000799.SZ', '酒鬼酒', '2016-01-01', '2016-12-31'],
        ['600519.SS', '贵州茅台', '2016-01-01', '2016-12-31'],
        ['600779.SS', '水井坊', '2016-01-01', '2016-12-31'],
	['000002.SZ', '万科A', '2016-01-01', '2016-12-31'],
	['300104.SZ', '乐视网', '2016-01-01', '2016-12-31'],
	['000651.SZ', '格力电器', '2016-01-01', '2016-12-31'],
        ['600887.SS', '伊利股份', '2016-01-01', '2016-12-31'],
        ['600839.SS', '四川长虹', '2016-01-01', '2016-12-31'],
        ['002308.SZ', '威创股份', '2016-01-01', '2016-12-31'], # 幼儿教育产业
        ['002638.SZ', '勤上光电', '2016-01-01', '2016-12-31'],
        ['300160.SZ', '秀强股份', '2016-01-01', '2016-12-31'],
        ['510050.SS',  '50ETF', '2016-01-01', '2016-12-31'],
        ['510300.SS',  '300ETF', '2016-01-01', '2016-12-31'],
        ['510500.SS',  '500ETF', '2016-01-01', '2016-12-31'],
        ['511010.SS',  '国债ETF', '2016-01-01', '2016-12-31'],                    
        ['518800.SS', '黄金基金', '2016-01-01', '2016-12-31'],
        ['159920.SS', '恒生ETF', '2016-01-01', '2016-12-31'],
        ['510900.SS', 'H股ETF', '2016-01-01', '2016-12-31'],
        ['159915.SZ', '创业板', '2016-01-01', '2016-12-31'],
        ['159902.SZ', '中小板', '2016-01-01', '2016-12-31'],
        ['150023.SZ', '深成指B', '2016-01-01', '2016-12-31'],          
        ['150201.SZ', '券商B', '2016-01-01', '2016-12-31'],
        ['150153.SZ', '创业板B', '2016-01-01', '2016-12-31'],
]
